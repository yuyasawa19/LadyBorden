...
import tokuronI.group1.denpyoukun.service.TsubuyakiService;
...
public class TsubuyakiController {
    ...
    // つぶやきを検索
    @GetMapping("/find")
    String findTsubuyaki(@RequestParam(value = "keyWord", required = true) String word, Model model) {
